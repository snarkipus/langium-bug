...
const block_madness_module_1 = require("../language-server/block-madness-module");
const cli_util_1 = require("./cli-util");
const generator_1 = require("./generator");
const node_1 = require("langium/node");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const services = (0, block_madness_module_1.createBlockMadnessServices)(node_1.NodeFileSystem).BlockMadness;
...
function default_1() {
    ...
    const fileExtensions = module_1.BlockMadnessLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
