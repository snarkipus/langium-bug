...
export interface BlockMadnessAstType {
    Goodbye: Goodbye
    Greeting: Greeting
    Model: Model
    Person: Person
...
export class BlockMadnessAstReflection extends AbstractAstReflection {
...
export const reflection = new BlockMadnessAstReflection();
